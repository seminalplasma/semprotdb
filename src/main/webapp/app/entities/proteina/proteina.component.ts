...
export default defineComponent({
  ...
  setup() {
    ...
    const prepareRemove = (instance: IProteina) => {
    ...
    const removeProteina = async () => {
      try {
        await proteinaService().delete(removeId.value);
        const message = t$('semprotdbApp.proteina.deleted', { param: removeId.value }).toString();
